...
class RoleController extends BaseApiController
{
    ...
    public function index(BaseIndexRequest $request): JsonResponse
    {
        ...
        $results = $this->roleService->findByIndexes(
            $indexes['indexes'],
            $indexes['any'],
            $indexes['limit'],
            $indexes['orderBy'],
        ...
        $formattedResponse = $this->paginateResponse($results, RoleResource::class);
    ...
    {
        $data = $this->roleService->findById($idOrSlug);
    ...
    {
        $data = $this->roleService->update($request->all(), $idOrSlug);
    ...
    public function destroy(string $idOrSlug): JsonResponse
    {
        ...
        $this->roleService->delete($idOrSlug);
